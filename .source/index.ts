...
import * as d_docs_0 from "../content/docs/getting-started-with-nextjs-shopify-commerce-starter.mdx?collection=docs"
...
export const docs = _runtime.docs<typeof _source.docs>([{ info: {"path":"getting-started-with-nextjs-shopify-commerce-starter.mdx","fullPath":"content\\docs\\getting-started-with-nextjs-shopify-commerce-starter.mdx"}, data: d_docs_0 }], [])